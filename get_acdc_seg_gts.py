...
config_file = 'config_files/dev_unet_acdc_123.ini'
...
# save the gts
output_dir = '/local/scratch/jz426/TransSR/Segmentation/ACDC_Seg_GTs'
...
testing_patient_ids = paras.testing_patient_ids_acdc
...
print('{} slices in total.'.format(total))